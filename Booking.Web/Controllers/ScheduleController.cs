...
namespace Booking.Web.Controllers
{
    ...
    public class ScheduleController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            return View("~/Views/Admin/Schedule/Index.cshtml", appointmentBooking);
        }

        [HttpPost]
        public Task<ActionResult> RmAppointment(AppointmentManager dtoAppointment)
        {
            _unitOfWork.UserAppointmentRepository.Delete(dtoAppointment.Id);
            _unitOfWork.Save();
            return (Index());
        }
    }
